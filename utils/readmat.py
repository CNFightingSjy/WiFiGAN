...
def getMat(path, key):
    # path = '/data/shijianyang/data/wifi/data4psp/ExperimentData/PeopleStanding/Pinc.mat'
...
def splitDataset(ptot_path, epsono_path):
    ...
    # print(ptot_test[0])
    moveFiles(ptot_train, '/data/shijianyang/data/wifi/data4psp/train/ptot/')
    moveFiles(ptot_test, '/data/shijianyang/data/wifi/data4psp/test/ptot/')
    moveFiles(epsono_train, '/data/shijianyang/data/wifi/data4psp/train/epsono/')
    moveFiles(epsono_test, '/data/shijianyang/data/wifi/data4psp/test/epsono/')
...
epsono_path = '/data/shijianyang/data/wifi/data4psp/new_epsono/'
ptot_path = '/data/shijianyang/data/wifi/data4psp/new_ptot/'
mat_path = '/data/shijianyang/data/wifi/epr_I'
m_path = '/data/shijianyang/data/wifi/h_result/1/epsono_r.mat'
gray_path = '/data/shijianyang/data/wifi/epr_mask'
rgb_path = '/data/shijianyang/data/wifi/data4psp/psp/epsono_rgb'

train_epsono_path = '/data/shijianyang/data/wifi/data4psp/train/epsono/'
train_rgb_path = '/data/shijianyang/data/wifi/data4psp/train/rgb_epsono/'
test_epsono_path = '/data/shijianyang/data/wifi/data4psp/test/epsono/'
test_rgb_path = '/data/shijianyang/data/wifi/data4psp/test/rgb_epsono/'
# 测试文件读取
# getMat(new_paths, 'a')

# 将wifi数据统一移动到/data4psp目录下
# moveMat(new_paths, epsono_path, ptot_path)
